...
function M.setup(colors, opts)
  return {
    ...
    ["@function.builtin"] = { fg = colors.accent, bold = true },
    ...
    ["@variable"] = vim.tbl_extend("force", { fg = colors.fg }, opts.styles.variables),
    ["@variable.builtin"] = { fg = colors.error },
    ["@variable.member"] = { fg = colors.fg },
    ["@variable.parameter"] = { fg = colors.fg_dim },
    ["@property"] = { fg = colors.fg },
    ["@module"] = { fg = colors.yellow },
    ["@module.builtin"] = { fg = colors.yellow, italic = true },
    ["@label"] = { link = "Label" },

    ["@tag"] = { link = "Tag" },
    ["@tag.attribute"] = { fg = colors.accent },
